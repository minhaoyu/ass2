...
public class ContainerQuay extends Quay implements Encodable {
    ...
    public boolean equals​(Object o){
        ...
        return this.getId() == ((ContainerQuay) o).getId() &&
                this.isEmpty() == ((ContainerQuay) o).isEmpty() &&
                this.getMaxContainers() == ((ContainerQuay)o).getMaxContainers();
    }
    ...
    public int hashCode(){
        ...
        String hashCode = getId() + status + getMaxContainers();
     ...
     * unoccupied.
     * maxContainers is the maximum number of containers this quay can handle
     * For example:
     * ContainerQuay:3:1258691:100
     * or
    ...
    public String encode(){
        return super.encode() + ":" + this.getMaxContainers();
    }
